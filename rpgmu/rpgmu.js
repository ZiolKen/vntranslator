...
const openaiPool = createPool(2);

async function translateOpenAIBatch(linesSafe, targetLang, apiKey, model, signal) {
  if (!Common || typeof Common.requestOpenAIChat !== "function") {
    throw new Error("OpenAI translation core is unavailable.");
  }
...
Context:
- You are working with raw dialogue strings extracted from a RPG Maker Ultimate text export.
- The visual novel includes romantic, emotional, and adult themes.
- Your translation will be directly used in-game, so accuracy, naturalness, and structural integrity are crucial.
